...
public class Restaurant {
	...
	public String toString() {
		return "Restaurant [id=" + id + ", title=" + title + ", subtitle=" + subtitle + ", description=" + description
				+ ", image=" + image + ", isFreeship=" + isFreeship + ", address=" + address + ", openDate=" + openDate
				+ ", listRatingRestaurant=" + listRatingRestaurant + ", listOrders=" + listOrders
				+ ", listMenuRestaurant=" + listMenuRestaurant + ", listPromotion=" + listPromotion + "]";
	}
}
